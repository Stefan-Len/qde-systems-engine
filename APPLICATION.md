...
1. Contact Stefan Len / QDE-Systems by LinkedIn, X, or email.
...
7. If accepted, a private checkout or delivery path may be provided.

Access is application-based and not automatic.
